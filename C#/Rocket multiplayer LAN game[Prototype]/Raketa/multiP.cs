...
namespace Raketa
{
	...
	public partial class multiP : Form
	{
		...
		class MetakJak : multiP
		{
			...
			Timer t;
			public Label ll;
			public MetakJak(int i,Label lc,multiP fc)
			{
				ff=fc;
		...
		void multiPKeyDown(object sender, KeyEventArgs e)
		{
			k=e.KeyCode;
		...
		void multiPKeyUp(object sender, KeyEventArgs e)
		{
		...
		void multiPKeyPress(object sender, KeyPressEventArgs e)
		{
	
		}
		void multiPLoad(object sender, EventArgs e)
		{
	
		}
		void multiPClick(object sender, EventArgs e)
		{
