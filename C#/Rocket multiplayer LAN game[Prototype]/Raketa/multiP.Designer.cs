...
namespace Raketa
{
	partial class multiP
	{
		...
		private void InitializeComponent()
		{
			...
			System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(multiP));
			...
			this.Name = "multiP";
			this.Text = "Raketa";
			this.Load += new System.EventHandler(this.multiPLoad);
			this.Click += new System.EventHandler(this.multiPClick);
			this.KeyDown += new System.Windows.Forms.KeyEventHandler(this.multiPKeyDown);
			this.KeyPress += new System.Windows.Forms.KeyPressEventHandler(this.multiPKeyPress);
			this.KeyUp += new System.Windows.Forms.KeyEventHandler(this.multiPKeyUp);
